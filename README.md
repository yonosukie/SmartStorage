...
本轮安装包：`artifacts/SmartStorage-0.6.0-debug.apk`。65 项测试通过，Lint 无问题；尚未进行本轮真机视觉验收。

v0.6.0 将统计收敛为到期提醒、分类分布和房间分布，采用分段状态条、柱状图、环形图与横向条形图，详见 [统计优化说明](docs/统计简化-v0.6.0.md)。
