...
object LayoutGrid {
    const val CELLS = 10
    fun resize(box: LayoutBox, widthCells: Int, heightCells: Int): LayoutBox = snap(box.copy(
        width = widthCells.coerceIn(1, CELLS).toFloat() / CELLS,
        height = heightCells.coerceIn(1, CELLS).toFloat() / CELLS))
